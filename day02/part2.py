testInputRaw = """Game 1: 3 blue, 4 red; 1 red, 2 green, 6 blue; 2 green
...
inputRaw = """Game 1: 1 green, 4 blue; 1 blue, 2 green, 1 red; 1 red, 1 green, 2 blue; 1 green, 1 red; 1 green; 1 green, 1 blue, 1 red
...
inputLines = inputRaw.splitlines()
#inputLines = testInputRaw.splitlines()

powerSum = 0

for inputLine in inputLines:
    game = inputLine.split(': ')[1]
    sets = game.split('; ')

    # will end up being the largest values of all the sets
    minNeededColorsGame = {
        'red': 0,
        'blue': 0,
        'green': 0,
    ...
    for set in sets:
        ...
        for draw in draws:
            ...
            num = int(splitDraw[0])
            color = splitDraw[1]
            minNeededColorsGame[color] = max(minNeededColorsGame[color], num)

    powerSum += minNeededColorsGame['red'] * minNeededColorsGame['blue'] * minNeededColorsGame['green']
